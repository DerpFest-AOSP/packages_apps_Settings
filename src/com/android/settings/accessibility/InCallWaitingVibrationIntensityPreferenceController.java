...
public class InCallWaitingVibrationIntensityPreferenceController
    ...
    public InCallWaitingVibrationIntensityPreferenceController(Context context, String preferenceKey) {
        super(context, preferenceKey, new InCallVibrationPreferenceConfig(context));
    }

    protected InCallWaitingVibrationIntensityPreferenceController(Context context, String preferenceKey,
